            ...
            def _load_from_state_dict(self, state_dict, prefix, local_metadata,
                ...
                if layer_conf is None:
                    ...
                    if self.quant_format in ["float8_e4m3fn", "float8_e5m2"]:
                        ...
                        # Physical byte layout of the five weight tensors — selects which
                        # kernel path `_w4a4_forward` dispatches to. Defaults to
                        # kitchen-native row-major; checkpoints produced by
                        # nunchaku/tools/kitchen_native/split_fused_qkv.py carry
                        # "nunchaku_zgemm_tile_packed" and go through the verbatim
                        # nunchaku zgemm port.
                        layout_flag = layer_conf.get("layout", "kitchen_row_major")
